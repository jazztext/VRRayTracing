...
class Mesh : public SceneObject {
 public:
   ...
   */
  Mesh(const HalfedgeMesh& mesh, VRRT::BSDF* bsdf);
 ...
 private:
  ...
  VRRT::BSDF* bsdf; ///< BSDF of surface material
...
class SphereObject : public SceneObject {
  ...
  */
  SphereObject(const Vector3D& o, double r, VRRT::BSDF* bsdf);
...
private:
  ...
  VRRT::BSDF* bsdf; ///< BSDF of the sphere objects' surface material
